  ...
  <div class="container">
    ...
    <section class="hero is-fullheight has-background" >
      ...
      <div class="columns is-centered">
        <!-- Button Section -->
        <nav class="column pagination is-dark is-four-fifths" role="navigation" aria-label="pagination">
          <a class="pagination-previous" style="padding: 1rem margin: 1rem">Next Image</a>
          <a class="pagination-next">Previous Image</a>
          <ul class="pagination-list">
            <li><a class="pagination-link is-current" aria-label="Goto page 1">Today {todaysDate}</a></li>
          </ul>
        </nav>
      </div>
