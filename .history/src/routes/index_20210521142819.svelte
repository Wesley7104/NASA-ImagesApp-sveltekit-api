  ...
  <div class="container">
    ...
    <section class="hero is-fullheight has-background" >
          ...
          <ul class="pagination-list">
           <li>
             <a class="pagination-previous" style="padding: 1rem margin: 1rem">Next Image</a>
              ...
              <li>
                <a class="pagination-link is-current" aria-label="Goto page 1">{apiComplete.date}</a>
              </li> 
            <li>
      ...
      <div class="hero-foot">
          ...
          <p class ="text myTextStyle">Image Copyright Info: {getImageCopyrightData(apiComplete)}</p>
      </div>
    </section>
