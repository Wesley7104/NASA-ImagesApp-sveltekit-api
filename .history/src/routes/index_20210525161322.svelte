...
<main>
  <div class="container">
    ...
    <section class="" >
      ...
      <div class="hero is-link is-fullheight has-background">
        <img class="hero-background" src={apiImage} alt={apiComplete.title}>
        <div class="hero-body">
          <div class="container">
            {#if apiVideo}
                <a class="button btn" style="color: lightgrey background-color:darkgrey;" href={apiComplete.url} target="_blank">Play Video</a>
            {/if}
            </div>
