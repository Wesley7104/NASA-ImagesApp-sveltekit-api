...
<script context="module">
  ...
  isImgPublicDomain = 'copyright' in apiComplete;

    if (isImgPublicDomain){
      console.log("Public Domain Image");
    } else {
      console.log(apiComplete.copyright);
    };

    // apiComplete.copyright || "Public Domain Image";
