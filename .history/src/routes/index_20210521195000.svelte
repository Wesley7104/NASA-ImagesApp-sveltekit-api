      ...
      <div class="columns is-centered">
        ...
        <div class="column is-four-fifths">
          ...
          <ul class="pagination-list">
           <li>
             <a class="pagination-next btn" style="padding: 1rem margin: 1rem">Next Image</a>
          </li>
              <li>
                <a class="pagination-link btn" aria-label="Goto page 1">{apiComplete.date}</a>
              </li> 
            <li>
              <a class="pagination-previous btn">Previous Image</a>
