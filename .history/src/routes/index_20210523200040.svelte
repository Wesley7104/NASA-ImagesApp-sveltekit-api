...
<script context="module">
  ...
  //  const unsubscribe = todaysDate.subscribe(value => {
	// 	todaysDate = value;
	// });
   ...
   if (apiComplete.url){
    ...
    todaysDate.update(format(new Date(), 'yyyy-MM-dd'));
    initialDate.update($todaysDate);
    currentImgDate.update($initialDate);
