  ...
  <div class="container">
    ...
    <section class="" >
      ...
      <div class="hero is-fullheight is-primary has-background">
        <img alt={apiComplete.title} class="hero-background" src={apiImage} />
      <div class="hero-body ">
        <!-- <img class="image" src={apiImage} alt={apiComplete.title}> -->
        
        {#if apiVideo}
          <div class="columns is-centered">
            <a class="button btn" style="color:dimgray" on:click={toggleModal}>Play Video</a>
          </div>
          <p class ="title text myTextStyle">Image Copyright Info: {isImgPublicDomain}</p>
         <h2 class="subtitle text myTextStyle">{apiComplete.explanation}</h2>
        {/if}
      </div>
