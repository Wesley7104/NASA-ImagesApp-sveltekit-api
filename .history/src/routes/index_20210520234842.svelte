<script context="module">
  ...
  <script>
   ...
   export function getTodaysDate(apiData) {
    todaysDate = apiData.date;
   };
        ...
        <div class="column is-four-fifths">
          <nav class="pagination is-dark is-centered" role="navigation" aria-label="pagination">
            ...
            <ul class="pagination-list">
              <li><a class="pagination-link is-current" aria-label="Goto page 1">Today {getTodaysDate(apiComplete.date)}</a></li>
            </ul>
          </nav>
          </div>
      </div>
