...
<script context="module">
  ...
  <script>
   ...
   onDestroy(unsubscribe, unsubscribe2, unsubscribe3);
    ...
    // replace initial store values with actual dates.
    if (today = "2000-01-01"){
...
<Modal message="Popup Modal message text." showModal={showModal} />
<main>
  <div class="container">
    ...
    <section class="hero is-fullheight has-background" >
      ...
      <div class="hero-body ">
        ...
        {#if apiVideo}
          <a on:click={openRequestedPopup}>Play Video</a> 
